...
function init()
  ...
  healthInfoButton = modules.client_topmenu.addRightGameToggleButton('healthInfoButton', tr('Player Information'), '/images/topbuttons/healthinfo', toggle)
  ...
  healthInfoWindow:getChildById('miniwindowTopBar').onDoubleClick = nil
end
