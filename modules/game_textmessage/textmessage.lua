MessageSettings = {
  ...
  centerWhite     = { color = TextColors.white,  consoleTab='Default', screenTarget='middleCenterLabel', consoleOption='showEventMessagesInConsole' },
  bottomWhite     = { color = TextColors.white,  consoleTab='Default', screenTarget='statusLabel',       consoleOption='showEventMessagesInConsole' },
  status          = { color = TextColors.white,  consoleTab='Default', screenTarget='statusLabel',       consoleOption='showStatusMessagesInConsole' },
